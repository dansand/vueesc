...
#print(Avg_temp, Rms, Max_vx_surf, Gravwork, Viscdis, Viscdisair, Viscdislith, etamax, etamin, Nu0loc, Nu1loc, Rmsurfloc)


# In[61]:

#Setup the global output arrays
#print(dTp, Nu0glob, dTp, Nu1glob, dTp, Rmsurfglob)
